...
- **`hx_clog_config_t` grows at the end only** (added in 1.1.0: `rotate_align`, `max_compressed_files`). Callers must initialize via `hx_clog_config_default()`; never insert fields in the middle.

...
| API、logger、formatter、sink、轮转、环境变量 | [docs/api.md](docs/api.md) | [docs/zh-CN/api.md](docs/zh-CN/api.md) |
| 模块划分、写入路径、线程模型、内存策略 | [docs/design.md](docs/design.md) | [docs/zh-CN/design.md](docs/zh-CN/design.md) |
| Crash handler、minidump、stacktrace、last-N logs | [docs/crash.md](docs/crash.md) | [docs/zh-CN/crash.md](docs/zh-CN/crash.md) |
| GitHub Actions、平台矩阵、本地验证命令 | [docs/ci.md](docs/ci.md) | [docs/zh-CN/ci.md](docs/zh-CN/ci.md) |
